    ...
    <div className="container">
      <div className="login-box">
        ...
        {step === "email" && <>
          ...
          <input type="email" placeholder="Email Address" className="input-box" value={email} onChange={(e) => setEmail(e.target.value)} />
          <button className="login-btn" onClick={handleSendOtp}>Send OTP</button>
        </>}
        {step === "otp" && <>
          <p>Enter the 6-digit OTP sent to your email</p>
          <input type="text" inputMode="numeric" maxLength="6" placeholder="6-digit OTP" className="input-box" value={otp} onChange={(e) => setOtp(e.target.value.replace(/\D/g, ""))} />
          <button className="login-btn" onClick={handleVerifyOtp}>Verify OTP</button>
        </>}
        {step === "password" && <>
          <p>Create your new password</p>
          <input type="password" placeholder="New Password" className="input-box" value={password} onChange={(e) => setPassword(e.target.value)} />
          <input type="password" placeholder="Confirm Password" className="input-box" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} />
